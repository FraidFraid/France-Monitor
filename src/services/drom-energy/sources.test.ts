...
describe('drom-energy · sources registry', () => {
  it('expose les 5 territoires DROM dans l’ordre attendu', () => {
  ...
  it('décrit les sources postes/production de La Réunion', () => {
  ...
  it('filtre les sources par territoire et par famille', () => {
  ...
  it('retourne des copies isolées (mutation sans effet de bord)', () => {
