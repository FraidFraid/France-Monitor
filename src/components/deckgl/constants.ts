...
export const SRC_HANTAVIRUS = 'hantavirus-src';
...
export const LYR_HANTAVIRUS_PULSE = 'hantavirus-pulse';
export const LYR_HANTAVIRUS_POINTS = 'hantavirus-points';
export const LYR_HANTAVIRUS_ZONES_FILL = 'hantavirus-zones-fill';
export const LYR_HANTAVIRUS_ZONES_STROKE = 'hantavirus-zones-stroke';
export const SRC_HANTA_ZONES = 'hanta-zones-src';
export const HANTA_HIST_DEP_CODES = ['08','39','54','55','57','67','68','70','88','69'];
