...
test('mergeDatacenters folds national OSM backbone and removes duplicate static sites', () => {
  const merged = mergeDatacenters({
    staticDatacenters: [
      {
        id: 'ovh-sbg',
...
test('mergeDatacenters prioritizes national project layer over overlapping OSM existing site', () => {
  const merged = mergeDatacenters({
    staticDatacenters: [],
    officialIdfDatacenters: [],
    providerStatus: {},
...
test('mergeDatacenters keeps same-provider campus sites and removes low-quality foreign OSM rows', () => {
  const merged = mergeDatacenters({
    staticDatacenters: [],
    officialIdfDatacenters: [],
    providerStatus: {
