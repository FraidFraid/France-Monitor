...
test('extractPeppsHantavirusSources returns hantavirus official sources from PEPS section', () => {
...
test('buildSnapshot overrides hard-coded asOf when fresher source date is available', () => {
  const snapshot = buildSnapshot({ latestSourceDate: '2026-05-19' });

  assert.equal(snapshot.asOf, '2026-05-19T00:00:00.000Z');
});
...
test('buildSnapshot and cluster templates use SPF live situation when available', () => {
