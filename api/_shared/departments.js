export const DEP_TO_REGION = {
  ...
  '92': '11', '93': '11', '94': '11', '95': '11', '2A': '94', '2B': '94', '971': '01', '972': '02', '973': '03', '974': '04', '976': '06',
};
...
export const DEPT_NAMES = {
  ...
  '2A': 'Corse-du-Sud', '2B': 'Haute-Corse', '971': 'Guadeloupe', '972': 'Martinique', '973': 'Guyane',
...
export function allDepartmentCodes() {
  return Object.keys(DEP_TO_REGION).sort((a, b) => a.localeCompare(b));
}
