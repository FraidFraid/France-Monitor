...
const DATACENTERS = [
    ...
    { id: 'aws-cdg',  name: 'AWS Paris (eu-west-3)', provider: 'AWS',   region: 'eu-west-3',   coordinates: [2.349,  48.864] },
...
const IXPS_STATIC = [
    { id: 'fix-par',  name: 'France-IX Paris',    city: 'Paris',     coordinates: [2.349,  48.864], speedGbps: 400 },
